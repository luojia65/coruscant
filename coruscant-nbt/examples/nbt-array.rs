...
struct Wrap<'a> {
    ...
    #[serde(serialize_with = "as_nbt_array")] // special attribute used, regard as ByteArray.
    byte_array: &'a [i8],
    #[serde(serialize_with = "as_nbt_array")] // same attribute, but for seq of i32 values,
